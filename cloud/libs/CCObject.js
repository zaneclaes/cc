...
exports.sanitizeKeysForParseSave = function(object) {
  if (typeof object !== 'object') {
    return object;
  }
  for (var k in object) {
    var mod = k.replace(/$\./gi,''),
        val = exports.sanitizeKeysForParseSave( object[k] );
    if (k !== mod) {
      console.log('replacing key '+k+' with '+mod);
      object[mod] = val;
      delete object[k];
    }
    else {
...
exports.byteSize = function( object ) {
